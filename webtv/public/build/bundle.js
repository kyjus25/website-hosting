    ...
    function create_default_slot_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(source, "data-src", "http://173.21.195.160:8080/hls/test.m3u8");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			img = element("img");
    			if (!src_url_equal(img.src, img_src_value = "http://webtv.international/wp-content/uploads/2018/04/fog-tv-web-tv-international-640x309-2018-04-09-at-2.png")) attr_dev(img, "src", img_src_value);
