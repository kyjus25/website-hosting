...
var app = (function () {
    ...
    const file$p = "node_modules/svelte-routing/src/Link.svelte";
    ...
    function create_fragment$t(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$p, 40, 0, 1249);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$o = "src/partials/Header.svelte";
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "404";
    			add_location(h1, file$3, 11, 12, 358);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if_block.c();
    			attr_dev(div, "class", "wrapper");
    			add_location(div, file$3, 7, 4, 238);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 3, 6, 134);
    			add_location(h1, file$2, 4, 6, 185);
    			attr_dev(div0, "id", "call-to-action");
    			attr_dev(div0, "class", "flex-1");
    			add_location(div0, file$2, 2, 4, 87);
    			add_location(p, file$2, 8, 8, 268);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "placeholder", "Pickup Location");
    			add_location(input0, file$2, 9, 8, 295);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "placeholder", "Destination");
    			add_location(input1, file$2, 10, 8, 353);
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "placeholder", "Estimated Distance");
    			add_location(input2, file$2, 11, 8, 407);
    			add_location(button, file$2, 12, 8, 468);
    			attr_dev(div1, "id", "form");
    			add_location(div1, file$2, 7, 6, 244);
    			add_location(div2, file$2, 6, 4, 232);
    			attr_dev(div3, "id", "schedule");
    			attr_dev(div3, "class", "wrapper flex flex-align flex-justify");
    			add_location(div3, file$2, 1, 2, 18);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t27 = space();
    			h11 = element("h1");
    			h11.textContent = "Some Things We Deliver...";
    			t29 = space();
    			div11 = element("div");
    			div8 = element("div");
    			i4 = element("i");
    			t30 = space();
    			h12 = element("h1");
    			h12.textContent = "Pets";
    			t32 = space();
    			div9 = element("div");
    			i5 = element("i");
    			t33 = space();
    			h13 = element("h1");
    			h13.textContent = "Vehicles";
    			t35 = space();
    			div10 = element("div");
    			i6 = element("i");
    			t36 = space();
    			h14 = element("h1");
    			h14.textContent = "Groceries";
    			t38 = space();
    			div15 = element("div");
    			div12 = element("div");
    			i7 = element("i");
    			t39 = space();
    			h15 = element("h1");
    			h15.textContent = "Luggage";
    			t41 = space();
    			div13 = element("div");
    			i8 = element("i");
    			t42 = space();
    			h16 = element("h1");
    			h16.textContent = "Building Material";
    			t44 = space();
    			div14 = element("div");
    			i9 = element("i");
    			t45 = space();
    			h17 = element("h1");
    			h17.textContent = "Appliances";
    			attr_dev(i0, "class", "fas fa-briefcase");
    			add_location(i0, file$1, 14, 3, 257);
    			add_location(h20, file$1, 15, 3, 293);
    			add_location(p0, file$1, 16, 3, 326);
    			attr_dev(div0, "class", "flex-1");
    			add_location(div0, file$1, 13, 2, 233);
    			attr_dev(i1, "class", "fas fa-shield-alt");
    			add_location(i1, file$1, 19, 3, 421);
    			add_location(h21, file$1, 20, 3, 458);
    			add_location(p1, file$1, 21, 3, 489);
    			attr_dev(div1, "class", "flex-1");
    			add_location(div1, file$1, 18, 2, 397);
    			attr_dev(i2, "class", "fas fa-house");
    			add_location(i2, file$1, 24, 3, 632);
    			add_location(h22, file$1, 25, 3, 664);
    			add_location(p2, file$1, 26, 3, 689);
    			attr_dev(div2, "class", "flex-1");
    			add_location(div2, file$1, 23, 2, 608);
    			attr_dev(i3, "class", "fas fa-users");
    			add_location(i3, file$1, 29, 3, 774);
    			add_location(h23, file$1, 30, 3, 806);
    			add_location(p3, file$1, 31, 3, 835);
    			attr_dev(div3, "class", "flex-1");
    			add_location(div3, file$1, 28, 2, 750);
    			attr_dev(div4, "id", "blocks");
    			attr_dev(div4, "class", "flex");
    			add_location(div4, file$1, 12, 1, 200);
    			attr_dev(div5, "id", "home-image");
    			add_location(div5, file$1, 37, 3, 987);
    			add_location(h10, file$1, 39, 4, 1028);
    			attr_dev(button, "class", "btn-primary active");
    			add_location(button, file$1, 41, 4, 1175);
    			add_location(div6, file$1, 38, 3, 1018);
    			attr_dev(div7, "class", "flex");
    			add_location(div7, file$1, 36, 2, 965);
    			add_location(br, file$1, 44, 2, 1251);
    			add_location(h11, file$1, 45, 2, 1258);
    			attr_dev(i4, "class", "fas fa-dog");
    			add_location(i4, file$1, 48, 4, 1354);
    			add_location(h12, file$1, 49, 4, 1385);
    			attr_dev(div8, "class", "flex-1");
    			add_location(div8, file$1, 47, 3, 1329);
    			attr_dev(i5, "class", "fas fa-car");
    			add_location(i5, file$1, 52, 4, 1437);
    			add_location(h13, file$1, 53, 4, 1468);
    			attr_dev(div9, "class", "flex-1");
    			add_location(div9, file$1, 51, 3, 1412);
    			attr_dev(i6, "class", "fas fa-shopping-basket");
    			add_location(i6, file$1, 56, 4, 1524);
    			add_location(h14, file$1, 57, 4, 1567);
    			attr_dev(div10, "class", "flex-1");
    			add_location(div10, file$1, 55, 3, 1499);
    			attr_dev(div11, "class", "shippables flex");
    			add_location(div11, file$1, 46, 2, 1296);
    			attr_dev(i7, "class", "fas fa-suitcase-rolling");
    			add_location(i7, file$1, 62, 4, 1665);
    			add_location(h15, file$1, 63, 4, 1709);
    			attr_dev(div12, "class", "flex-1");
    			add_location(div12, file$1, 61, 3, 1640);
    			attr_dev(i8, "class", "fas fa-hard-hat");
    			add_location(i8, file$1, 66, 4, 1764);
    			add_location(h16, file$1, 67, 4, 1800);
    			attr_dev(div13, "class", "flex-1");
    			add_location(div13, file$1, 65, 3, 1739);
    			attr_dev(i9, "class", "fas fa-calendar");
    			add_location(i9, file$1, 70, 4, 1865);
    			add_location(h17, file$1, 71, 4, 1901);
    			attr_dev(div14, "class", "flex-1");
    			add_location(div14, file$1, 69, 3, 1840);
    			attr_dev(div15, "class", "shippables flex");
    			add_location(div15, file$1, 60, 2, 1607);
    			attr_dev(div16, "id", "about");
    			attr_dev(div16, "class", "wrapper");
    			add_location(div16, file$1, 35, 1, 930);
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(div6, h10);
    			append_dev(div6, t23);
    			mount_component(sveltemarkdown, div6, null);
    			append_dev(div6, t24);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 26, 3, 796);
    			attr_dev(div1, "class", "flex");
    			attr_dev(div1, "id", "loading");
    			add_location(div1, file, 25, 2, 761);
    		},
    		m: function mount(target, anchor) {
    ...
    // (31:2) <Route path="/pages/:id" let:params>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(31:2) <Route path=\\\"/pages/:id\\\" let:params>",
    		ctx
    	});
